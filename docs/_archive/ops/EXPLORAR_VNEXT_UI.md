# EXPLORAR_VNEXT_UI — ARCHIVED (alcance cancelado)

**Motivo:** Se intentó construir Explore V3 con nuevo framework UI, pero se **revirtió**.  
Este documento queda como referencia histórica. La fuente de verdad actual es `docs/ops/*` + `docs/contracts/*` y el sprint activo (Strangler) mantiene UI legacy.
