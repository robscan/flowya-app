...
- **Toasts**: supresión selectiva del toast de cambio de filtro y del toast de pin cuando sheet expandido (`filterChangeToastSuppressedRef` temprano en render); sin toast al abrir países visitados desde pastilla si el sheet sustituye el mensaje; `suppressToastRef` no bloquea feedback global por countries expanded.
