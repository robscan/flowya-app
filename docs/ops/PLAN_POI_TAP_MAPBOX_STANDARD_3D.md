...
**Resumen:** Cambiar a Mapbox Standard como estilo predeterminado, habilitar navegación 3D con control nativo, implementar el flujo "Agregar spot / Por visitar" al hacer tap en un POI que no está en Flowya, y alinear visualmente los pines con Mapbox.
