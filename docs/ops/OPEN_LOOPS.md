...
- **En espera (cola — sin incluir el loop activo):**
  ...
  5. **OL-EXPLORE-COUNTRIES-SHEET-LAYOUT-001** — **Cerrado (2026-04-18):** KPI países+mapa sin buscador ni barra filtros Lugares; scroll cuerpo KPI. Bitácora [`366`](../bitacora/2026/04/366-ol-explore-countries-sheet-layout-kpi-map-chrome-scroll.md).
...
| **OL-EXPLORE-COUNTRIES-SHEET-LAYOUT-001** (**cerrado** 2026-04-18) | KPI sin buscador/filtros; scroll bloque mapa+lista | [`366`](../bitacora/2026/04/366-ol-explore-countries-sheet-layout-kpi-map-chrome-scroll.md) |
