...
- **En espera (cola — sin incluir el loop activo):**
  ...
  3. **OL-EXPLORE-FILTERS-ENTRY-LAYOUT-001** — **Cerrado (2026-04-18):** botón primario, copy «Etiquetas y filtros», fila única con launcher de búsqueda en sheet (sin duplicar header). Bitácora [`364`](../bitacora/2026/04/364-ol-explore-filters-entry-layout-sheet-search-row.md).
...
| **OL-EXPLORE-FILTERS-ENTRY-LAYOUT-001** (**cerrado** 2026-04-18) | CTA primario + fila búsqueda en sheet Lugares | [`364`](../bitacora/2026/04/364-ol-explore-filters-entry-layout-sheet-search-row.md) |
