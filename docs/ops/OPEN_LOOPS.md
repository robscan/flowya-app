...
**Cierre de jornada 2026-04-26:** se para en un punto seguro. Quedan aplicadas/verificadas las migraciones `033`–`037`; `038_spot_covers_orphan_candidates_backup.sql` queda solo como backup/listado y el cleanup real de Storage se difiere porque Supabase exige Storage API. **Al retomar:** continuar en `OL-DATA-MODEL-INTROSPECTION-001`, decisión de campos mínimos en `spots` (`coordinate_source`, `created_from`, `country_code`, `region_code`, `city_name`). Bitácora: [`394`](../bitacora/2026/04/394-cierre-jornada-gate-v1-data-media-map.md).
