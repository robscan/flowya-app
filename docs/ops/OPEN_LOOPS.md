...
| **OL-I18N-EN-001** | UI en inglés: **Explore + auth + editar spot**; excl. vitrina `/design-system` y rutas solo de prueba ([§4b plan ejecución](plans/PLAN_EXECUTION_POST_WR001_2026-04-12.md)) | [PLAN_EXECUTION_POST_WR001…](plans/PLAN_EXECUTION_POST_WR001_2026-04-12.md) §4b |
