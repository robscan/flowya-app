/**
 * Privacidad de fotos — plataformas no web: stub (paridad con `privacy.web.tsx`).
 */
...
export default function AccountPrivacyScreenNative() {
  ...
  return (
    ...
    >
      ...
      <Text style={[TypographyStyles.body, { color: colors.textSecondary, marginBottom: Spacing.lg }]}>
        Disponible en la versión web por ahora.
      </Text>
      <Pressable
