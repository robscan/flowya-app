/**
 * Cuenta (subruta) — plataformas no web: stub (OL-PROFILE-001 centrado en web).
 * Expo Router exige hermano sin sufijo para `account.web.tsx`.
 */
...
export default function AccountAccountScreenNative() {
